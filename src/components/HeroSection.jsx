...
const MainText = () => {
    ...
    <div className='mt-20 text-center'>
        <h1 className='text-6xl md:text-7xl lg:text-9xl text-white-50 font-bold'>{t('hero-content')}</h1>
        ...
        <p className="mt-6 mb-16 text-gray-300 text-xs md:text-lg lg:text-xl max-w-xl mx-auto">
          {t('hero-subtext', 'Innovative web development tailored for your business needs.')}
        </p>
    </div>
